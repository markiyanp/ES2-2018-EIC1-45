...
//				   {"test2-should-appear-VAR-INTEG", "Integer", "-2", "5", null, true},
//				   {"test3-should-appear-VAR-INTEG", "Integer", "-10", "10", null, true},
//				   {"test4-should-not-appear-VAR-INTEG", "Integer", "-10", "10", null, false}};
//		Object[][] testOI = {
//				{"test1-should-appear-OBJ-VAR-INTEG", "Integer", true},
//				{"test2-should-not-appear-OBJ-VAR-INTEG", "Double", false},
//				{"test3-should-appear-OBJ-VAR-INTEG", "Integer", true},
//				{"test5-should-not-appear-OBJ-VAR-INTEG", "Integer", false}
//		};
